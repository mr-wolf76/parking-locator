        ...
        <div class="collapse navbar-collapse" id="navbarMainContent">
            ...
            <div class="d-flex align-items-center gap-2">
                <?php if (isAdminLoggedIn()): ?>
                    <a href="<?php echo adminUrl('/admin/index.php'); ?>" class="btn btn-outline-primary btn-sm px-3" id="nav-btn-admin-dash">
                        <i class="bi bi-speedometer2 me-1"></i> Dashboard
                    </a>
                    <a href="<?php echo adminUrl('/admin/logout.php'); ?>" class="btn btn-light btn-sm text-secondary px-2" id="nav-btn-admin-logout" title="Logout">
